...
TEGLTOT = TEGL1+TEGL2+TEGL3+TEGL4 ;
...
GL1M = positif(REV2+REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * GLN1 / TOTALQUOHT) +
     (1 - positif(REV2+REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * TONEQUOMHT;
GL2M = positif(REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * GLN2 / TOTALQUOHT) +
     (1 - positif(REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT-GL1M);
GL3M = positif(REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * GLN3 / TOTALQUOHT) +
     (1 - positif(REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT - GL1M - GL2M);
...
GL4M = positif(REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * REV4 / TOTALQUOHT) +
     (1 - positif(REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT - GL1M - GL2M - GL3M);
...
GLPRRVM = positif(PRR2C+PRR21+PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR2V / TOTALQUOHT) +
      (1 - positif(PRR2C+PRR21+PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM);
GLPRRCM = positif(PRR21+PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR2C / TOTALQUOHT) +
      (1 - positif(PRR21+PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM-GLPRRVM);
GLPRR1M = positif(PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR21 / TOTALQUOHT) +
      (1 - positif(PRR22+PRR23+PRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM-GLPRRVM-GLPRRCM);
GLPRR2M = positif(PRR23+PRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR22 / TOTALQUOHT) +
      (1 - positif(PRR23+PRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM-GLPRRVM-GLPRRCM-GLPRR1M);
GLPRR3M = positif(PRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR23 / TOTALQUOHT) +
      (1 - positif(PRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOMHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM-GLPRRVM-GLPRRCM-GLPRR1M-GLPRR2M);
GLPRR4M = positif(REVRVO+REVRCM+REVRF)*arr(TONEQUOMHT * PRR24 / TOTALQUOHT) +
      (1 - positif(REVRCM+REVRF)) * (TONEQUOMHT-GLTOTM-GLFTOTM-GLPALIMTOTM-GLTSTOTM-GLTSREMPTOTM-GLPRRVM-GLPRRCM-GLPRR1M-GLPRR2M-GLPRR3M);
...
TGL2M = positif(REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TGLN2 / TOTALQUO) +
     (1 - positif(REV3+REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOM-TGL1M);
TGL3M = positif(REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TGLN3 / TOTALQUO) +
     (1 - positif(REV4+REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOM - TGL1M - TGL2M);
...
TGL4M = positif(REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * REV4 / TOTALQUO) +
     (1 - positif(REVF+REVALIM+REVTS+REVTSREMP+REVPRR+REVRVO+REVRCM+REVRF)) * (TONEQUOM - TGL1M - TGL2M - TGL3M);
TGLTOTM = somme(i=1..4:TGLiM);
...
TGLPRRVM = positif(TPRR2C+TPRR21+TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR2V / TOTALQUO) +
      (1 - positif(TPRR2C+TPRR21+TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOM-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM);
TGLPRRCM = positif(TPRR21+TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR2C / TOTALQUO) +
      (1 - positif(TPRR21+TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOM-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM-TGLPRRVM);
TGLPRR1M = positif(TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR21 / TOTALQUO) +
      (1 - positif(TPRR22+TPRR23+TPRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOM-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM-TGLPRRVM-TGLPRRCM);
TGLPRR2M = positif(TPRR23+TPRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR22 / TOTALQUO) +
      (1 - positif(TPRR23+TPRR24+REVRVO+REVRCM+REVRF)) * (TONEQUO-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM-TGLPRRVM-TGLPRRCM-TGLPRR1M);
TGLPRR3M = positif(TPRR24+REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR23 / TOTALQUO) +
      (1 - positif(TPRR24+REVRVO+REVRCM+REVRF)) * (TONEQUOM-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM-TGLPRRVM-TGLPRRCM-TGLPRR1M-TGLPRR2M);
TGLPRR4M = positif(REVRVO+REVRCM+REVRF)*arr(TONEQUOM * TPRR24 / TOTALQUO) +
      (1 - positif(REVRCM+REVRF)) * (TONEQUOM-TGLTOTM-TGLFTOTM-TGLPALIMTOTM-TGLTSTOTM-TGLTSREMPTOTM-TGLPRRVM-TGLPRRCM-TGLPRR1M-TGLPRR2M-TGLPRR3M);
TGLPRRTOTM = somme(i=V,C,1..4:TGLPRRiM);
...
pour i=V,C:
TRPQPALIMiM = inf(TGLPALIMiM/CARPENBAi);
pour i=1..4:
TRPQPALIMiM = inf(TGLPALIMiM/CARPENBAPi);
...
pour i=V,C:
TRPQPRRiM = inf(TGLPRRiM/PENSALNBi);
pour i=1..4:
TRPQPRRiM = inf(TGLPRRiM/PENSALNBPi);
...
RBGRFR = (1 - positif(RGRFR  + R1649 +PREREV- DAR)) * min( 0 , RGRFR  + R1649 +PREREV- DAR + TOTALQUO )
    + positif(RGRFR  + R1649+PREREV - DAR) * (RGRFR  + R1649+PREREV - DAR);
regle 7051:
application : iliad , batch  ;
...
RG1731R = (1 - positif(IPVLOC)) * (
        ( SHBA1731R 
          +  max( BANOR1731R, 0 ) + REB +
        min(BANOR1731R,0) *
        positif(SEUIL_IMPDEFBA + 1 - SHBA1731R - (REVTP-BA1)
        - REVQTOTQHT) 
       ) ) 
     +
     positif( IPVLOC ) * IPVLOC;
...
regle 7061:
application : iliad , batch  ;
DAR = ((DEFAA5 * (1 - positif(ART1731BIS)))
     + (DEFAA4 * (1 - positif(ART1731BIS))) 
     + (DEFAA3 * (1 - positif(ART1731BIS))) 
     + (DEFAA2 * (1 - positif(ART1731BIS))) 
     + (DEFAA1 * (1 - positif(ART1731BIS))) 
     + (DEFAA0 * (1 - positif(ART1731BIS)))) * (1 - positif(IPVLOC));
regle 707:
application : iliad , batch  ;
PVBAR3VG =  BPVRCM + PVTAXSB + BPVKRI ;
PVBAR3SB =  PVTAXSB + COD3WI + PVIMPOS + COD3VE ;
PVBAR3WB =  PVIMPOS + COD3WI ;
PVBAR3VE =  COD3VE;
PVBAR =  max(0,(BPVRCM + COD3SG + COD3SL + ABDETPLUS + ABIMPPV) - (DPVRCM + COD3SH + COD3SM + ABDETMOINS + ABIMPMV));
PVBARPS =  max(0,(BPVRCM + COD3SG + COD3SL + ABDETPLUS + ABIMPPV) - (DPVRCM + COD3SH + COD3SM + ABDETMOINS + ABIMPMV)) + BPVKRI + PVTITRESOC;
SHBA = ESFP + TSPR + RCM + BIN + BNN + PLOCNETF + NPLOCNETF
       + BPVRCM + PVTAXSB + (PVIMPOS + COD3WI) * (1-null(1-FLAG_EXIT)) + BPVKRI + COD3VE + PVSURSI * null(2 -FLAG_EXIT)
       + (RRFI + 0) * ( 1- V_INDTEO) + (RRFTEO + 0) * (V_INDTEO);
SHBA1731R = ESFP + TSPR + RCM + BIN1731R + BNN1731R + PLOCNETF1731R + NPLOCNETF1731R
       + BPVRCM + PVTAXSB + (PVIMPOS + COD3WI) * (1-null(1-FLAG_EXIT)) + BPVKRI + COD3VE + PVSURSI * null(2 -FLAG_EXIT)
       + (RRFI1731R + 0) * ( 1- V_INDTEO) + (RRFTEO + 0) * (V_INDTEO);
