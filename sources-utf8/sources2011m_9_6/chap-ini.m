...
SOMMEA874 =  somme(i=V,C,1,2,3,4:present(TSHALLOi) + present(ALLOi) + present(PRBRi) + present(PALIi))
	    ...
	    + present ( BICHREC ) + present ( LOCNPC ) + present ( BICHDEC ) + present ( LOCDEFNPC ) 
	    + present ( BICHREP ) + present ( LOCNPPAC ) + present ( BICHDEP ) + present ( LOCDEFNPPAC )
	    + present ( MIBMEUV ) + present ( MIBGITEV ) + present ( MIBNPVENV ) 
	    + present ( MIBNPPRESV ) + present ( MIBNP1AV ) + present ( MIBNPDEV ) 
	    + present ( MIBMEUC ) + present ( MIBGITEC ) + present ( MIBNPVENC ) 
	    + present ( MIBNPPRESC ) + present ( MIBNP1AC ) + present ( MIBNPDEC ) 
	    + present ( MIBMEUP ) + present ( MIBGITEP ) + present ( MIBNPVENP ) 
...
SOMMEA884 =  present ( TSHALLOV ) + present ( TSHALLOC ) + present ( TSHALLO1 ) + present ( TSHALLO2 ) 
	   ...
	   + present ( BICREV ) + present ( LOCNPCGAV ) 
	   + present ( BICREC ) + present ( LOCNPCGAC )
	   + present ( BICREP ) + present ( LOCNPCGAPAC ) 
	   + present ( BICHREV ) + present ( LOCNPV ) 
	   + present ( BICHREC ) + present ( LOCNPC )
	   + present ( BICHREP ) + present ( LOCNPPAC ) 
           + present ( MIBMEUV ) + present ( MIBGITEV ) + present ( MIBNPVENV ) + present ( MIBNPPRESV ) 
	   + present ( MIBMEUC ) + present ( MIBGITEC ) + present ( MIBNPVENC ) + present ( MIBNPPRESC ) 
	   + present ( MIBMEUP ) + present ( MIBGITEP ) + present ( MIBNPVENP ) + present ( MIBNPPRESP ) 
...
SOMMEA538VB =  present ( BAFORESTV ) + present ( BAFPVV ) + present ( BACREV ) + present ( 4BACREV ) 
	     ...
	     + present ( BICREV ) + present ( LOCNPCGAV ) + present ( BICHREV ) + present ( LOCNPV )
...
SOMMEA538CB =  present ( BAFORESTC ) + present ( BAFPVC ) + present ( BACREC ) + present ( 4BACREC ) 
	     + present ( BAHREC ) + present ( 4BAHREC ) + present ( MIBVENC ) + present ( MIBPRESC )
             ...
             + present ( BICREC ) + present ( LOCNPCGAC ) + present ( BICHREC ) + present ( LOCNPC )
...
SOMMEA538PB =  present ( BAFORESTP ) + present ( BAFPVP ) + present ( BACREP ) + present ( 4BACREP ) 
	     ...
	     + present ( LOCPROP ) + present ( MIBNPVENP ) + present ( MIBNPPRESP ) + present ( MIBNPPVP )
             + present ( BICREP ) + present ( LOCNPCGAPAC ) + present ( BICHREP ) + present ( LOCNPPAC )
...
SOMMEA862 =  
    ...
    + present( MIBPVV ) + present( MIB1AV ) + present( MIBDEV ) 
    + present( MIBEXC ) + present( MIBVENC ) + present( MIBPRESC ) 
    + present( MIBPVC ) + present( MIB1AC ) + present( MIBDEC ) 
    + present( MIBEXP ) + present( MIBVENP ) + present( MIBPRESP ) 
    + present( MIBPVP ) + present( MIB1AP ) + present( MIBDEP ) 
    + present( MIBDCT ) 
    + present( BICEXV ) + present( BICNOV ) + present( LOCPROCGAV ) 
    + present( BI1AV ) + present( BICDNV ) + present( LOCDEFPROCGAV ) 
    + present( BICEXC ) + present( BICNOC ) + present( LOCPROCGAC ) 
    ...
    + present( MIBMEUV ) + present( MIBGITEV ) + present( MIBNPEXV ) + present( MIBNPVENV ) 
    + present( MIBNPPRESV ) + present( MIBNPPVV ) + present( MIBNP1AV ) + present( MIBNPDEV ) 
    + present( MIBMEUC ) + present( MIBGITEC ) + present( MIBNPEXC ) + present( MIBNPVENC ) 
    + present( MIBNPPRESC ) + present( MIBNPPVC ) + present( MIBNP1AC ) + present( MIBNPDEC ) 
    + present( MIBMEUP ) + present( MIBGITEP ) + present( MIBNPEXP ) + present( MIBNPVENP ) 
    ...
    + present( BNCPROEXV ) + present( BNCPROV ) + present( BNCPROPVV ) + present( BNCPRO1AV ) + present( BNCPRODEV ) 
    + present( BNCPROEXC ) + present( BNCPROC ) + present( BNCPROPVC ) + present( BNCPRO1AC ) + present( BNCPRODEC ) 
    + present( BNCPROEXP ) + present( BNCPROP ) + present( BNCPROPVP ) + present( BNCPRO1AP ) + present( BNCPRODEP )
    + present( BNCPRODCT ) 
    + present( BNCEXV ) + present( BNCREV ) + present( BN1AV ) + present( BNCDEV ) 
    + present( BNCEXC ) + present( BNCREC ) + present( BN1AC ) + present( BNCDEC )
    + present( BNCEXP ) + present( BNCREP ) + present( BN1AP ) + present( BNCDEP ) 
