...
MAJOISF07TARDIF_F = FLAG_RETARD * null(FLAG_TRDEGTR - 7) * arr(ISF4 * TAUX_2042/100);
MAJOISF08TARDIF_F = FLAG_RETARD * null(FLAG_TRDEGTR - 8) * arr(ISF4 * TAUX_2042/100);
MAJOISF17TARDIF_F = FLAG_RETARD * null(FLAG_TRDEGTR - 17) * arr(ISF4 * TAUX_2042/100);
