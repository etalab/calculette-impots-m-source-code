...
INRISF_R9901 = arr(ISF_R9901 * (TXINRISF_PA/100)-INCISF_NET_A) * positif(ISF_R9901- ISF_R9901_A)
              * positif(IND_PASSAGE-1) * positif(ISF_NTLDEC-ISF_R9901) * positif(ISF_R9901_A)
             + (arr(ISF_R9901 * (TXINRISF_PA/100))-INCISF_NET_A) * positif(ISF_R9901- ISF4BASE_A)
              * positif(IND_PASSAGE-1) * positif(ISF_NTLDEC-ISF_R9901) * (1-positif(ISF_R9901_A))
             + (INCISF_NET_A - arr(ISF_R9901 * (TXINRISF_PA/100))) * positif(ISF4BASE_A- ISF_R9901)
              * positif(IND_PASSAGE-1) * positif(ISF_NTLDEC-ISF_R9901) * (1-positif(ISF_R9901_A)) * positif(ISF_R9901)
	     ;
...
RECUP_INR_ISF = (min(DO_INR_ISF_A,arr(DO_INR_ISF_A * (ISF_NTLDEC - ISF4BASE_A)/DO_ISF_A))
                    *positif(ISF_NTLDEC-ISF_A)*positif(ISF_REF-ISF4BASE_A)
                    * positif(ISF4BASE_A -ISF_R9901)
                    *positif(FLAG_RETARD + FLAG_DEFAUT))
		+ min(DO_INR_ISF_A,arr((ISF_R9901 - ISF4BASE_A) * TXINRISF_PA/100))*positif(ISF_NTLDEC - ISF4BASE_A)
...
INRISF_NET2 = max(INRISF_NTLDECD+INRISF_R99R+RECUP_INR_ISF,0)* positif(ISF4BASE - ISF_P)*(1-IND_RJLJ)+DO_INR_ISF2 * (-1);
