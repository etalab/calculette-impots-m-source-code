...
ZIPQPRR35 = positif(TEGLPRR4M+TEGLTSTOTM+TEGLTSREMPTOTM+TEGLRVOTOTM+TEGLRFTOTM) *arr(IQUOTOT5*TERPQPRR3M/TETONEQUOM1)
         + (1 - positif(TEGLPRR4M+TEGLTSTOTM+TEGLTSREMPTOTM+TEGLRVOTOTM+TEGLRFTOTM)) * 
           (IQUOTOT5-ZIPQ5TOT-ZIPQF5TOT-ZIPQPALIM5TOT-ZIPQRCM5TOT-ZIPQPRRV5-ZIPQPRRC5-ZIPQPRR15-ZIPQPRR25);
pour z=1,2:
ZIPQPRR4z = positif(TEGLTSTOT+TEGLTSREMPTOT+TEGLRVOTOT+TEGLRFTOT) * arr(IQUOTOTz*TERPQPRR4/TETONEQUO1)
...
ZIPQPRRANT41 = positif(TEGLTSTOT+TEGLTSREMPTOT+TEGLRVOTOT+TEGLRFTOT) * arr(IQUOTOTANT1*TERPQPRR4/TETONEQUO1)
         + (1 - positif(TEGLTSTOT+TEGLTSREMPTOT+TEGLRVOTOT+TEGLRFTOT)) * 
...
ZIPQPRR45 = positif(TEGLTSTOTM+TEGLTSREMPTOTM+TEGLRVOTOTM+TEGLRFTOTM) *arr(IQUOTOT5*TERPQPRR4M/TETONEQUOM1)
...
pour z=1,2:
IQUODAJz = arr(IPQ100z * (TERPQ4V + TERPQ4C)/TERPQ4TVC);
pour z=1,2:
IQUOEAJz = max(0,IPQ100z - IQUODAJz);
pour z=1,2:
...
pour z=1,2:
ITOTDOMz = IMETROz + INETABADAJz + INETABAEAJz;
...
pour z=1,2:
IQUODAJ3z = arr(IPQ100z * (TERPQ4V + TERPQ4C)/TERPQ4TVC);
pour z=1,2:
IQUOEAJ3z = max(0,IPQ100z - IQUODAJ3z);
pour z=1,2:
...
pour z=1,2:
ITOTDOM3z = IMETRO3z + INETABADAJ3z +  INETABAEAJ3z;
