...
LIGNIDB = positif(null(IDOM11 - DEC11)
...
LIG_REPORT = positif(LIGRNIDF + somme(i=0..5:LIGRNIDFi)
	     ...
	     + LIGREPRR + LIGREPRUP + LIGREPRVQ + LIGREPRWR + LIGREPRYT + LIGREPNW 
             ...
             + LIGREPDOMENT + LIGREPDOMOUT 
             + LIGPME3 + LIGPME2 + LIGPME1 + LIGPMECU
             + LIGRSN  + LIGRSN1 + LIGRSN0
             + LIGPLAFRSN + LIGPLAFRSN4
...
LIGRDUFLOGIH = positif(RIVDUFLOGIH) * LIG1 * LIG2 ;
regle 111388:
application : iliad, batch;
...
LIGRRCEL1 = positif(RRCEL2013A + RRCELMG) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
LIGRRCEL11 = positif(RRCELMG) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
LIGRRCEL12 = positif(RRCEL2013A) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIGRRCEL2 = positif(RRCELLF + RRCELLZ + RRCEL2013B) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
...
LIGRRCEL23 = positif(RRCEL2013B) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIGRRCEL3 = positif(RRCELLC + RRCELLD + RRCELLS + RRCEL2013C) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
...
LIGRRCEL34 = positif(RRCEL2013C) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIGRRCEL4 = positif(RRCELLA + RRCELLB + RRCELLE + RRCELLM + RRCEL2013D) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
...
LIGRRCEL45 = positif(RRCEL2013D) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;
...
LIGREPKG = positif(REPKG) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPQKG = positif(REPKG + REPKI + REPQK + REPQX + REPRD) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPQUS = positif(REPQS + REPQU + REPRA) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPQWB = positif(REPQW + REPRB) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGREPRC = positif(REPRC) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGREPMM = positif(REPMM) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPMMQE = positif(REPRJ + REPMM + REPMN + REPQE) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGREPLG = positif(REPLG) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPLI = positif(REPLI) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPQFLG = positif(REPLI + REPLG) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGREPMA = positif(REPMA) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPMC = positif(REPMC) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPQGMA = positif(REPMC + REPMA) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGREPKS = positif(REPKS) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPKU = positif(REPKU) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGREPQIKS = positif(REPKU + REPKS) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPEK = positif(REPPE + REPRP + REPSK) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPFL = positif(REPPF + REPRQ + REPSL) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPHO = positif(REPPH + REPRT + REPSO) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPIZ = positif(REPPI + REPNU + REPSZ) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPJA = positif(REPPJ + REPNV + REPTA) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPPLB = positif(REPPL + REPNY + REPTD) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPRUP = positif(REPRU + REPSP) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPRVQ = positif(REPRV + REPSQ) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPRWR = positif(REPRW + REPSR) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGREPRYT = positif(REPRY + REPST) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
...
LIGRSN = positif(RINVTPME12 + RINVTPME13) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGRSN1 = positif(RINVTPME12) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGRSN0 = positif(RINVTPME13) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGPLAFRSN = positif(PLAFREPSN4) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;
LIGPLAFRSN4= positif(PLAFREPSN4) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 ;

LIGFOREST = positif(REPFOREST + REPFOREST2 + REPFOREST3 + REPEST) * LIG1 * LIG2 * (1 - V_CNR) ;
...
ZIG_RVTO = positif (CS_RVT + RD_RVT + PS_RVT + IND_ZIGRVT)
                   * (1 - V_CNR) * (1 - positif(ANNUL2042)) * LIG1 * LIG2 * LIGPSP ;
regle 117100:
application : batch, iliad;
...
ZIG_PROF = positif(CS_REVCS+RD_REVCS+PS_REVCS+IND_ZIGPROF)
                   * (1 - V_CNR) * (1 - positif(ANNUL2042)) * LIG1 * LIGPSP ;
regle 117110:
application : batch, iliad;
...
ZIG_RF = positif(CS_RFG + RD_RFG + PS_RFG + IND_ZIGRFG) * (1 - null(4 - V_REGCO)) * (1 - positif(ANNUL2042)) * LIG1 * LIG2 * LIGPSP ;
regle 117181:
application :batch,  iliad;
...
LIGPS = positif(BCSG + BRDS + BPRS + BCVNSAL + BCDIS + BGLOA + BRSE1 + BRSE2 + BRSE3 + BRSE4 + BRSE5 + 0) 
	 * (1 - positif(ANNUL2042)) ;
...
regle 117440:
application : batch, iliad;
ZIG_NETAP =  positif (BCSG  + BRDS + BPRS + BCVNSAL + BCDIS + BGLOA + BRSE1 + BRSE2 + BRSE3 + BRSE4 + BRSE5)
             * LIG2 ;
regle 117450:
application : batch, iliad;
...
ZIG_CSGD99 = ZIG_CSGDPRIM * (1 - null(V_IDANT + DCSGD + 0)) * positif(20 - V_NOTRAIT) ;
...
LIGPVSURSI = positif(PVSURSI) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO));

LIGPVSURSIF = positif(PVSURSIWF) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO));

LIGPVSURSIG = positif(PVSURSIWG) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO));
...
LIGIREXIT = positif(PVIMPOS + COD3WI) * positif(PVSURSI) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIGPV3WBI = positif(PVIMPOS + COD3WI) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIGEXITAX3 = positif(EXITTAX3) * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) * LIG1 * LIG2 ;

LIG_SURSIS = positif( LIGPVSURSI + LIGPVSURSIF + LIGPVSURSIG + LIGBPTPGJ + LIGIREXITI
...
LIGTXMOYPOS = positif(present(RMOND)+positif(VARRMOND)*present(DEFZU)) * (1 - ART1731BIS) * LIG1 * LIG2 ;

LIGTXMOYNEG = positif(DMOND) * (1 - ART1731BIS) * LIG1 * LIG2 ;

LIGTXPOSYT = positif(present(RMOND)+positif(VARRMOND)*present(DEFZU)) * ART1731BIS * LIG1 * LIG2 ;

LIGTXNEGYT = positif(DMOND) * ART1731BIS * LIG1 * LIG2 ;
...
LIGREPTOUR = positif(REPINVLOCINV + RINVLOCINV + REPINVTOU + INVLOCXN + COD7UY) * LIG1 ;
...
LIGREPHA  = positif(REPINVLOCREA + RINVLOCREA + INVLOGREHA + INVLOCXV + COD7UZ) * LIG1 * LIG2 ;

LIGREVMOD = positif(RREVMOD_1) * LIG1 * LIG2 ;
...
LIGREPCODJT = positif(REPLNPV) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;
LIGREPLNPV = positif(REPLNPV) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;

LIGREPLOCNT = positif(REPLNPW + REPLOCNT) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;
...
LIGRESIREP = positif(REPMEUIZ + REPRESINEUV + REPLNPX) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;
...
LIGREPMEU = positif(REPINVRED + REPMEUIH + REPLOCN1 + REPLNPY) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;
...
LIGREPNEUV = positif(MEUBLERED + REPREDREP + REPMEUIX + REPLOCN2 + REPLNPZ) * LIG1 * LIG2 * (1 - null(2 - V_REGCO)) * (1 - null(4 - V_REGCO)) ;
...
LIG_MEMO = ( positif(LIGPRELIB + LIG_SURSIS + LIGREPPLU + LIGELURAS + LIGELURASC + LIGABDET + LIGABDETP
                     + LIGABDETM + LIGPVJEUNE + LIGROBOR + LIGPVPART + LIGPVIMMO + LIGPVTISOC + LIGMOBNR 
...
DEPCHO = (DEPCHOBAS + CIBOIBAIL + CINRJBAIL + CRENRJ + CINRJ + CIDEP15 + MATISOSI + MATISOSJ
	  + VOLISO + PORENT + ELESOL + CHAUBOISN + CHAUBOISO + POMPESP + POMPESQ + POMPESR
	  + CHAUFSOL + ENERGIEST + EAUPLUV + DIAGPERF + RESCHAL) * positif(V_NOTRAIT - 10) ;
...
LIG121 = LIGANNUL2042 * positif(ART1731BIS) ;
LIG931 = LIGANNUL2042 * positif(ART1731BIS) ;
LIG936 = LIGANNUL2042 * positif(ART1731BIS) ;
